...
# ==========================================
# GAME 1: 3D CLICK-TO-SPLIT HTML/JS
# ==========================================
GAME_3D_HTML = """<!DOCTYPE html>
<html>
<head>
  <style>
    body { margin: 0; overflow: hidden; background: #141419; font-family: sans-serif; }
    ...
    #counter-3d {
      ...
      font-weight: bold; border: 1px solid #00ffcc; z-index: 10;
    }
  </style>
...
# ==========================================
# GAME 2: 2D GROUND-SPLIT HTML/JS
# ==========================================
GAME_2D_HTML = """<!DOCTYPE html>
<html>
<head>
  <style>
    body { margin: 0; overflow: hidden; background: #1a1a24; font-family: sans-serif; }
    ...
    #counter-2d {
      position: absolute; top: 15px; left: 15px;
      background: rgba(0, 0, 0, 0.7); color: #ff0077;
      padding: 8px 16px; border-radius: 8px; font-size: 18px;
      font-weight: bold; border: 1px solid #ff0077; z-index: 10;
    }
  </style>
</head>
<body>
...
with tab1:
    st.write("Click a cube directly to drop and split it in 3D space. Click elsewhere to gather all active cubes to your cursor.")
    components.html(GAME_3D_HTML, height=620, scrolling=False)

with tab2:
    st.write("Click anywhere to drop or gather cubes. Every cube automatically **splits into two when hitting the ground**!")
